...
let favoriteFoods = [ 'lasagna', 'sushi', 'chicken', 'filet mignon']

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above
console.log ('my favotite foods include:' , favoriteFoods);
...
console.log('4, favoritefoods.length')
...
favoriteFoods.push('avacado toast');
...
console.log('the foods are ', favoriteFoods)
